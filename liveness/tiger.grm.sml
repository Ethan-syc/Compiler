\\060\000\036\000\105\000\104\000\
\\056\000\100\000\017\000\009\000\
\\084\000\093\000\009\000\108\000\
\\068\000\049\000\074\000\069\000\
\\075\000\044\000\025\000\028\000\
\\059\000\009\000\009\000\041\000\
\\053\000\009\000\052\000\018\000\
\\026\000\009\000\029\000\019\000\
\\020\000\038\000\103\000\009\000\
\\101\000\071\000\070\000\076\000\
\\009\000\021\000\030\000\073\000\
\\009\000\054\000\079\000\042\000\
\\022\000\106\000\009\000\072\000\
\\080\000\000\000"
val gotoT =
"\
\\001\000\002\000\002\000\145\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\003\000\035\000\004\000\034\000\005\000\033\000\006\000\032\000\
\\007\000\031\000\015\000\030\000\016\000\029\000\000\000\
\\000\000\
\\001\000\041\000\008\000\001\000\000\000\
\\001\000\042\000\008\000\001\000\000\000\
\\001\000\043\000\008\000\001\000\000\000\
\\001\000\045\000\008\000\001\000\013\000\044\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\050\000\008\000\001\000\000\000\
\\000\000\
\\001\000\052\000\008\000\001\000\000\000\
\\001\000\053\000\008\000\001\000\000\000\
\\001\000\054\000\008\000\001\000\000\000\
\\001\000\055\000\008\000\001\000\000\000\
\\001\000\056\000\008\000\001\000\000\000\
\\001\000\057\000\008\000\001\000\000\000\
\\001\000\058\000\008\000\001\000\000\000\
\\001\000\059\000\008\000\001\000\000\000\
\\001\000\060\000\008\000\001\000\000\000\
\\001\000\061\000\008\000\001\000\000\000\
\\001\000\062\000\008\000\001\000\000\000\
\\001\000\063\000\008\000\001\000\000\000\
\\001\000\064\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\007\000\031\000\015\000\065\000\000\000\
\\000\000\
\\005\000\033\000\016\000\066\000\000\000\
...
\\000\000\
\\000\000\
\\001\000\073\000\008\000\001\000\014\000\072\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\001\000\081\000\008\000\001\000\000\000\
\\001\000\083\000\008\000\001\000\011\000\082\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\073\000\008\000\001\000\014\000\086\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\093\000\008\000\001\000\000\000\
\\001\000\094\000\008\000\001\000\000\000\
\\001\000\095\000\008\000\001\000\000\000\
\\000\000\
\\001\000\045\000\008\000\001\000\013\000\096\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\009\000\104\000\000\000\
\\001\000\108\000\008\000\001\000\000\000\
\\000\000\
\\010\000\110\000\000\000\
\\000\000\
\\001\000\073\000\008\000\001\000\014\000\112\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\116\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\001\000\118\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\125\000\008\000\001\000\000\000\
\\001\000\126\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\001\000\128\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\131\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\137\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\138\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\141\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\144\000\008\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\"
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | ID of unit ->  (string) | tydecs of unit ->  (A.dec)
 | fundecs of unit ->  (A.dec)
 | expsInLet of unit ->  ( ( A.exp * A.pos )  list)
 | expseq of unit ->  ( ( A.exp * A.pos )  list)
 | reclist of unit ->  ( ( A.symbol * A.exp * A.pos )  list)
...
MlyValue.arglist arglist1, arglist1left, _)) :: rest671)) => let val  
result = MlyValue.arglist (fn _ => let val  (arglist as arglist1) = 
arglist1 ()
...
MlyValue.ID ID1, IDleft, _)) :: _ :: ( _, ( MlyValue.reclist reclist1,
 reclist1left, _)) :: rest671)) => let val  result = MlyValue.reclist
 (fn _ => let val  (reclist as reclist1) = reclist1 ()
 val  (ID as ID1) = ID1 ()
 val  (exp as exp1) = exp1 ()
 in (reclist@[(S.symbol ID, exp, IDleft)])
end)
 in ( LrTable.NT 11, ( result, reclist1left, exp1right), rest671)
end
|  ( 5, ( rest671)) => let val  result = MlyValue.reclist (fn _ => ([]
))
 in ( LrTable.NT 11, ( result, defaultPos, defaultPos), rest671)
end
|  ( 6, ( ( _, ( MlyValue.expseq expseq1, _, expseq1right)) :: _ :: (
...
|  ( 7, ( ( _, ( MlyValue.exp exp1, (expleft as exp1left), exp1right))
...
|  ( 8, ( ( _, ( MlyValue.exp exp1, (expleft as exp1left), exp1right))
 :: rest671)) => let val  result = MlyValue.expsInLet (fn _ => let
 val  (exp as exp1) = exp1 ()
 in ([(exp, expleft)])
end)
 in ( LrTable.NT 13, ( result, exp1left, exp1right), rest671)
end
|  ( 9, ( ( _, ( MlyValue.expsInLet expsInLet1, _, expsInLet1right))
 :: _ :: ( _, ( MlyValue.exp exp1, (expleft as exp1left), _)) :: 
rest671)) => let val  result = MlyValue.expsInLet (fn _ => let val  (
exp as exp1) = exp1 ()
 val  (expsInLet as expsInLet1) = expsInLet1 ()
 in ((exp, expleft)::expsInLet)
end)
 in ( LrTable.NT 13, ( result, exp1left, expsInLet1right), rest671)

end
|  ( 10, ( rest671)) => let val  result = MlyValue.expsInLet (fn _ =>
 ([]))
 in ( LrTable.NT 13, ( result, defaultPos, defaultPos), rest671)
end
|  ( 11, ( ( _, ( MlyValue.tydecs tydecs1, tydecs1left, tydecs1right))
...
|  ( 12, ( ( _, ( MlyValue.vardec vardec1, vardec1left, vardec1right))
 :: rest671)) => let val  result = MlyValue.dec (fn _ => let val  (
...
|  ( 13, ( ( _, ( MlyValue.fundecs fundecs1, fundecs1left, 
...
|  ( 15, ( ( _, ( MlyValue.dec dec1, dec1left, dec1right)) :: rest671)
...
|  ( 16, ( ( _, ( MlyValue.tydecs tydecs1, _, tydecs1right)) :: ( _, (
...
result = MlyValue.tydecs (fn _ => let val  (tydec as tydec1) = tydec1
 ...
 in (
case (tydec, tydecs) of (A.TypeDec(t1), A.TypeDec(t2)) => A.TypeDec (t1@t2)
                                           | _ => ErrorMsg.impossible "tydec must be list"
)
end)
 in ( LrTable.NT 15, ( result, tydec1left, tydecs1right), rest671)
end
|  ( 17, ( ( _, ( MlyValue.tydec tydec1, tydec1left, tydec1right)) :: 
...
ID1 ()
 val  (ty as ty1) = ty1 ()
 in (A.TypeDec [{name=S.symbol ID, ty=ty, pos=IDleft}])
end)
...
tyfields1 ()
 ...
 val  ID2 = ID2 ()
 in (
tyfields@[{name=S.symbol ID1, escape=ref false, typ=S.symbol ID2, pos=ID1left}]
)
end)
 in ( LrTable.NT 9, ( result, tyfields1left, ID2right), rest671)
end
|  ( 23, ( ( _, ( MlyValue.ID ID2, _, ID2right)) :: _ :: ( _, ( 
MlyValue.ID ID1, ID1left, _)) :: rest671)) => let val  result = 
MlyValue.tyfields (fn _ => let val  ID1 = ID1 ()
 val  ID2 = ID2 ()
 in (
[{name=S.symbol ID1, escape=ref false, typ=S.symbol ID2, pos=ID1left}]
)
end)
 in ( LrTable.NT 9, ( result, ID1left, ID2right), rest671)
end
|  ( 24, ( rest671)) => let val  result = MlyValue.tyfields (fn _ => (
[]))
...
ID1 ()
 val  (exp as exp1) = exp1 ()
 in (
A.VarDec {name=S.symbol ID, escape=ref false, typ=NONE, init=exp, pos=IDleft}
)
end)
...
fundec1 ()
 ...
 in (
case (fundec, fundecs) of (A.FunctionDec(f1), A.FunctionDec(f2)) => A.FunctionDec (f1@f2)
                                                | _ => ErrorMsg.impossible "fundec must be list"
)
end)
 in ( LrTable.NT 14, ( result, fundec1left, fundecs1right), rest671)

end
|  ( 28, ( ( _, ( MlyValue.fundec fundec1, fundec1left, fundec1right))
...
|  ( 37, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.expseq 
...
|  ( 40, ( ( _, ( MlyValue.STRING STRING1, (STRINGleft as STRING1left)
...
|  ( 42, ( ( _, ( _, _, RPAREN1right)) :: _ :: ( _, ( MlyValue.ID ID1,
...
|  ( 43, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.arglist 
arglist1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, (IDleft as ID1left),
 _)) :: rest671)) => let val  result = MlyValue.exp (fn _ => let val 
 (ID as ID1) = ID1 ()
 val  (arglist as arglist1) = arglist1 ()
 in (A.CallExp {func=S.symbol ID, args=arglist, pos=IDleft})
end)
 in ( LrTable.NT 0, ( result, ID1left, RPAREN1right), rest671)
end
...
|  ( 56, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.reclist 
reclist1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, (IDleft as ID1left),
 _)) :: rest671)) => let val  result = MlyValue.exp (fn _ => let val 
 (ID as ID1) = ID1 ()
 val  (reclist as reclist1) = reclist1 ()
 in (A.RecordExp {fields=reclist, typ=S.symbol ID, pos=IDleft})
end)
 in ( LrTable.NT 0, ( result, ID1left, RBRACE1right), rest671)
end
|  ( 57, ( ( _, ( MlyValue.exp exp2, _, exp2right)) :: _ :: _ :: ( _, 
...
|  ( 59, ( ( _, ( MlyValue.exp exp3, _, exp3right)) :: _ :: ( _, ( 
...
|  ( 62, ( ( _, ( MlyValue.exp exp3, _, exp3right)) :: _ :: ( _, ( 
MlyValue.exp exp2, _, _)) :: _ :: ( _, ( MlyValue.exp exp1, _, _)) ::
 ...
 val  exp3 = exp3 ()
 in (
A.ForExp {var=S.symbol ID, escape=ref false, lo=exp1, hi=exp2, body=exp3, pos=FORleft}
)
end)
 in ( LrTable.NT 0, ( result, FOR1left, exp3right), rest671)
end
|  ( 63, ( ( _, ( _, (BREAKleft as BREAK1left), BREAK1right)) :: 
rest671)) => let val  result = MlyValue.exp (fn _ => (
A.BreakExp BREAKleft))
 in ( LrTable.NT 0, ( result, BREAK1left, BREAK1right), rest671)
end
|  ( 64, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.expsInLet 
expsInLet1, _, _)) :: _ :: ( _, ( MlyValue.decs decs1, _, _)) :: ( _, 
( _, (LETleft as LET1left), _)) :: rest671)) => let val  result = 
MlyValue.exp (fn _ => let val  (decs as decs1) = decs1 ()
 val  (expsInLet as expsInLet1) = expsInLet1 ()
 in (A.LetExp {decs=decs, body= A.SeqExp expsInLet, pos=LETleft})
end)
 in ( LrTable.NT 0, ( result, LET1left, END1right), rest671)
end
|  ( 65, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.expsInLet 
expsInLet1, _, _)) :: _ :: ( _, ( _, (LETleft as LET1left), _)) :: 
rest671)) => let val  result = MlyValue.exp (fn _ => let val  (
expsInLet as expsInLet1) = expsInLet1 ()
 in (A.LetExp {decs=[], body= A.SeqExp expsInLet, pos=LETleft})
end)
 in ( LrTable.NT 0, ( result, LET1left, END1right), rest671)
end
