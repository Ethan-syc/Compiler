...
tig_exit:
        ...
        .end        tig_exit
tig_boundsCheck:
        # $a0: length of array; $a1: index
        addi        $sp, $sp, -4
        sw          $ra, 0($sp)
        bltz        $a1, tigbc_printlt
        sub         $t0, $a1, $a0       # $t0 = index - length
        bltz        $t0, tigbc_return
        j           tigbc_printge
tigbc_printlt:
        la          $a0, tigbc_lt
        jal         tig_printz
...
tigbc_return:
        ...
        jr          $ra
        .data
tigbc_lt: .asciiz   "Array index cannot be less than 0"
tigbc_ge: .asciiz   "Array index out of bounds"
        .text
tig_checkNil:
        # $a0: address of record
        beq         $a0, $0, tigcn_fail
        jr          $ra
tigcn_fail:
        la          $a0 tigcn_npe
